...
namespace Spielsücht
{
    public partial class MainForm : Form
    {
        ...
        private void MainFormLoad(object sender, EventArgs e)
        {
            ...
            if (Ratespiel.Properties.Settings.Default.Schwierigkeit == "Leicht")
            {
            ...
            if (Ratespiel.Properties.Settings.Default.Schwierigkeit == "Mittel")
            {
            ...
            if (Ratespiel.Properties.Settings.Default.Schwierigkeit == "Schwer")
            {
        ...
        private void RadioBtn_SchwerCheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Aktuelle_Schwierigkeit = "Schwer";
                Ratespiel.Properties.Settings.Default.Schwierigkeit = "Schwer";
                Ratespiel.Properties.Settings.Default.Save();
                Maximal_Random = 101;
                Verzinsung = 0.30;
                lbl_Schwierigkeit.Text = "Schwierigkeit: (von 1 bis " + (Maximal_Random - 1) + " && " + string.Format("{0:0%}", Verzinsung) + ")";
        ...
        private void RadioBtn_MittelCheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Aktuelle_Schwierigkeit = "Mittel";
                Ratespiel.Properties.Settings.Default.Schwierigkeit = "Mittel";
                Ratespiel.Properties.Settings.Default.Save();
                Maximal_Random = 21;
                Verzinsung = 0.13;
                lbl_Schwierigkeit.Text = "Schwierigkeit: (von 1 bis " + (Maximal_Random - 1) + " && " + string.Format("{0:0%}", Verzinsung) + ")";
        ...
        private void RadioBtn_LeichtCheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Aktuelle_Schwierigkeit = "Leicht";
                Ratespiel.Properties.Settings.Default.Schwierigkeit = "Leicht";
                Ratespiel.Properties.Settings.Default.Save();
                Maximal_Random = 11;
                Verzinsung = 0.05;
